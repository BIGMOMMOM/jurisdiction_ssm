        ...
        <section class="content"> <!--订单信息-->
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-2 title">旅游城市</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="旅游城市"
                               value="${product.cityName }" readonly="readonly">
                    </div>

                    <%--<div class="col-md-2 title">产品简介</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="产品价格"
                               value="${product.productDesc}" readonly="readonly">
                    </div>--%>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right"
                                   id="datepicker-a6" value="${product.departureTimeStr}"
                                   readonly="readonly">
                        </div>
                    </div>
